...
# =============================================================================
# UPDATE TEST BSC BRIDGE SCRIPT
# =============================================================================
#
# PURPOSE: This script updates the test hosted bridge by copying files
#          from liberdus-bsc-bridge-ui to liberdus.github.io/test-bsc-bridge
#
...
# 3. The script must have execute permissions: chmod +x update-test-bsc-bridge.sh
#
# WHAT IT DOES:
# - Copies the bridge UI into test-bsc-bridge
# - Removes development-only files that should not be published to GitHub Pages
# - Sets js/config.js RUNTIME.PROFILE to prod
# - Increments CONFIG.APP.VERSION patch in js/config.js (semver X.Y.Z)
...
TARGET_DIR="$REPO_DIR/test-bsc-bridge"
...
echo "Test BSC bridge update completed successfully."

...
# =============================================================================
# UPDATE TEST REWARDS SCRIPT
# =============================================================================
#
# PURPOSE: This script updates the test hosted airdrop frontend by copying
#          the frontend directory from liberdus-airdrop into
#          liberdus.github.io/rewards-test
#
...
#
# WHAT IT DOES:
# - Copies only the frontend contents into rewards-test
# - Excludes local and environment-specific config variants from the sync
# - Copies config.test.json into the target as config.json
#
# =============================================================================
...
TARGET_DIR="$REPO_DIR/rewards-test"
SOURCE_CONFIG_FILE="config.test.json"
...
echo "Test rewards update completed successfully."

...
export const NETWORK_TOKENS = {
    Polygon: [
        {
            address: '0xee3c3fdcf76e1ad12d2c199a8334335fb8b5dc6c',
            symbol: 'POL',
            name: 'POL',
            decimals: 18,
            balance: 0,
            logoURI: `https://raw.githubusercontent.com/Uniswap/assets/master/blockchains/polygon/assets/0x0000000000000000000000000000000000001010/logo.png`
        },
        {
            address: '0x3730f410e91f146089325fbd23f49d9ef544964f',
            symbol: 'TT1',
            name: 'Test Token 1',
            decimals: 18,
            balance: 0,
        ...
        {
            address: '0xaeefe2dfe3be401ff26dcd8884c4b1c1913156bf',
            symbol: 'TEST',
            name: 'Test Token',
            decimals: 18,
            balance: 0,
    ...
    try {
        ...
        for (const token of predefinedTokens) {
            try {
                ...
                warn(`Error loading predefined token at ${token.address}:`, error.message);
                continue;
            }
        }
